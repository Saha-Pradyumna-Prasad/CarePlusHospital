<div class="sidebar bg-dark text-white" style="width: 250px; height: 100vh; position: fixed; top: 0; left: 0; z-index: 100; overflow-y: auto; overflow-x: hidden; transition: all 0.3s ease;">
    <div class="sidebar-header p-3">
        <h5 class="fs-6 fs-md-5 mb-0"><i class="fas fa-hospital-user"></i> <span class="d-none d-md-inline">HMS Dashboard</span><span class="d-inline d-md-none">HMS</span></h5>
    </div>
    ...
    <ul class="nav flex-column pb-4">
        ...
        {{-- @role('patient') --}}
        <h3><b><u><i>Patient Menu</i></u></b></h3>
        <li class="nav-item">
            <a class="nav-link text-white py-2 py-md-3" href="{{ route('patient.appointments') }}">
                <i class="fas fa-calendar-alt me-2"></i> <span class="d-none d-md-inline">My Appointments</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white py-2 py-md-3" href="{{ route('patient.reports') }}">
                <i class="fas fa-file-medical me-2"></i> <span class="d-none d-md-inline">My Reports</span>
            </a>
        </li>
        {{-- @endrole --}}
    </ul>
