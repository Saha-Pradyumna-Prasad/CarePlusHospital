<div class="sidebar bg-dark text-white" style="width: 250px; height: 100vh; position: fixed; top: 0; left: 0; z-index: 100; overflow-y: auto; overflow-x: hidden; transition: all 0.3s ease;">
    ...
    <ul class="nav flex-column pb-4">
        ...
        {{-- @role('lab_tester') --}}
        <h3><b><u><i>Lab-Tester Menu</i></u></b></h3>
        <li class="nav-item">
            <a class="nav-link text-white py-2 py-md-3" href="{{ route('lab.tests') }}">
                <i class="fas fa-flask me-2"></i> <span class="d-none d-md-inline">Lab Tests</span>
            </a>
        </li>
