<div class="sidebar bg-dark text-white" style="width: 250px; height: 100vh; position: fixed; top: 0; left: 0; z-index: 100; overflow-y: auto; overflow-x: hidden; transition: all 0.3s ease;">
    ...
    <ul class="nav flex-column pb-4">
        ...
        {{-- @role('doctor') --}}
        <h3><b><u><i>Doctor Menu</i></u></b></h3>
        <li class="nav-item">
            <a class="nav-link text-white py-2 py-md-3" href="{{ route('doctor.patients') }}">
                <i class="fas fa-procedures me-2"></i> <span class="d-none d-md-inline">My Patients</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white py-2 py-md-3" href="{{ route('doctor.appointments') }}">
                <i class="fas fa-calendar-check me-2"></i> <span class="d-none d-md-inline">Appointments</span>
            </a>
        </li>
        {{-- @endrole --}}
