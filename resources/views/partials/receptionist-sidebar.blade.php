<div class="sidebar bg-dark text-white" style="width: 250px; height: 100vh; position: fixed; top: 0; left: 0; z-index: 100; overflow-y: auto; overflow-x: hidden; transition: all 0.3s ease;">
    ...
    <ul class="nav flex-column pb-4">
       ...
       {{-- @role('receptionist') --}}
       <h3><b><u><i>Receptionist Menu</i></u></b></h3>
<li class="nav-item">
    
</li>
<li class="nav-item">
    <a class="nav-link text-white py-2 py-md-3" href="{{ route('receptionist.appointments') }}">
        <i class="fas fa-calendar-plus me-2"></i> <span class="d-none d-md-inline">Manage Appointments</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link text-white py-2 py-md-3" href="{{ route('receptionist.patients') }}">
        <i class="fas fa-procedures me-2"></i> <span class="d-none d-md-inline">Manage Patients</span>
    </a>
</li>
{{-- @endrole --}}
