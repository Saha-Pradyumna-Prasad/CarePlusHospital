<div class="sidebar bg-dark text-white" style="width: 250px; height: 100vh; position: fixed; top: 0; left: 0; z-index: 100; overflow-y: auto; overflow-x: hidden; transition: all 0.3s ease;">
    ...
    <ul class="nav flex-column pb-4">
        ...
        {{-- @role('manager') --}}
    <h3><b><u><i>Manager Menu</i></u></b></h3>
        <li class="nav-item">
            <a class="nav-link text-white py-2 py-md-3" href="{{ route('manager.staff') }}">
                <i class="fas fa-users me-2"></i> <span class="d-none d-md-inline">Staff Management</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-white py-2 py-md-3" href="{{ route('manager.rooms') }}">
                <i class="fas fa-bed me-2"></i> <span class="d-none d-md-inline">Rooms Management</span>
            </a>
        </li>
        {{-- @endrole --}}
