                ...
                <table class="table table-bordered datatable w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">{{ $patient->blood_group ?? 'N/A' }}</td>
                            <td class="align-middle">
                                <div class="d-flex flex-wrap gap-1">
                                    ...
                                    <form action="{{ route('receptionist.patients.delete', $patient->id) }}" method="POST" class="d-inline delete-form" onsubmit="return confirm('Are you sure?')">
                                        @csrf 
                                        @method('DELETE')
...
<!-- Add Patient Modal - Pure PHP (No AJAX) -->
...
<!-- Edit Patient Modal - Pure PHP (No AJAX) -->
...
$(document).ready(function() {
    ...
    $('.edit-patient-btn').on('click', function() {
        ...
        $('#editPatientForm').attr('action', '/receptionist/patients/' + id);
